...
const Contact = () => {
  return (
    <div
      name="contact"
      className="w-full min-h-screen bg-gradient-to-bl from-orange-100 via-orange-50 to-orange-100 dark:from-gray-800 dark:via-gray-900 dark:to-black pt-20 p-4 dark:text-white"
    >
